...
public class BlackKey extends Key {
    ...
    public static List<BlackKey> generatorBlackKey(float whiteKeyWidth, float blackKeyWidth, float blackKeyHeight, Bitmap unPressedBitmap, Bitmap pressedBitmap, int blackKeyContinue) {
